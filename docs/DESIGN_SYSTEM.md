...
- **Task surfaces** (`/workouts/new`, `/workouts/[workoutId]/edit`) carry no nav chrome. They get a sticky header with one 44px exit control. Save and every other logger action live in the bottom-right tools dial.
