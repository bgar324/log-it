...
export const publicProfileStyles = {
  ...
  infoTooltip:
    "pointer-events-none absolute right-0 top-[calc(100%+0.42rem)] z-20 w-max max-w-[12rem] rounded-[0.46rem] border border-[var(--profile-border)] bg-[var(--bg)] px-[0.62rem] py-[0.42rem] text-[0.72rem] leading-[1.2] text-[var(--text)] opacity-0 shadow-[0_10px_24px_color-mix(in_srgb,#000_10%,transparent)] transition-[opacity,transform] duration-150 translate-y-[-0.12rem] group-hover:translate-y-0 group-hover:opacity-100 group-focus-visible:translate-y-0 group-focus-visible:opacity-100",
