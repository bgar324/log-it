...
import { fieldBoxed, fieldUnderline } from "@/app/_legacy/components/field.styles";
...
export const styles = {
  ...
  setRowWithoutDuration: cn(
    "grid grid-cols-[1.4rem_minmax(0,1fr)_3.5rem_2.75rem] items-center gap-[0.34rem] bg-transparent",
    "max-[380px]:grid-cols-[1.25rem_minmax(0,1fr)_3.3rem_2.75rem] max-[380px]:gap-[0.26rem]",
