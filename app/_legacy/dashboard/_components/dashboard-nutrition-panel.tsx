...
const NutritionCaloriesChart = dynamic(
  () => import("@/app/dashboard/_components/nutrition-charts").then((module) => module.NutritionCaloriesChart),
);
const BodyWeightChart = dynamic(
  () => import("@/app/dashboard/_components/nutrition-charts").then((module) => module.BodyWeightChart),
);
