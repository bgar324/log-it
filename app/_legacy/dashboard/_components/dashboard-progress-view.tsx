...
import { countLabel, daysAgoLabel } from "@/app/_legacy/dashboard/dashboard-client.shared";
...
import { DashboardViewSkeleton, ProgressChartsSkeleton } from "@/app/_legacy/dashboard/_components/dashboard-view-skeleton";

const ProgressCharts = dynamic(
  () => import("@/app/_legacy/dashboard/progress-charts").then((module) => module.ProgressCharts),
